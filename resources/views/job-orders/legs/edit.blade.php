...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setupFormattedInput('pic_amount_display_edit', 'pic_amount_input_edit');
    ...
    // Setup formatted input for insured value (nilai pertanggungan) - Edit mode
    setupFormattedInput('insured_value_display_edit', 'insured_value_edit');
