...
@section('content')
    <div class="mb-4 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400">Master data pengemudi</p>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('drivers.create') }}" class="px-4 py-2 rounded bg-indigo-600 hover:bg-indigo-700 text-white">+ Tambah Baru</a>
